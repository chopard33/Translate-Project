...
namespace KoreanAIO.Champions
{
    public class ChampionBase
    {
        ...
        public Menu ComboMenu
        {
            get
            {
                return MenuManager.GetSubMenu("连招");
            }
        }
        public Menu KillStealMenu
        {
            get
            {
                return MenuManager.GetSubMenu("抢人头");
            }
        }
        public Menu HarassMenu
        {
            get
            {
                return MenuManager.GetSubMenu("骚扰");
            }
        }
        public Menu ClearMenu
        {
            get
            {
                return MenuManager.GetSubMenu("清线");
            }
        }
        public Menu PredictionMenu
        {
            get
            {
                return MenuManager.GetSubMenu("预判");
            }
        }
        public Menu DrawingsMenu
        {
            get
            {
                return MenuManager.GetSubMenu("线圈");
            }
        }
        ...
        public Menu AutomaticMenu
        {
            get
            {
                return MenuManager.GetSubMenu("自动");
            }
        }
        public Menu MiscMenu
        {
            get
            {
                return MenuManager.GetSubMenu("杂项");
            }
        }
        public Menu KeysMenu
        {
            get
            {
                return MenuManager.GetSubMenu("热键");
            }
        }
