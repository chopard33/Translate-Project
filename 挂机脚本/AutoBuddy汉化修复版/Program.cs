...
// Environment.SpecialFolder.ApplicationData), "AutoBuddy"));
            ...
            CheckBox newpf = new CheckBox("使用智能路径选择", true);
            
            menu.Add("newPF", newpf);
            newpf.OnValueChange += newpf_OnValueChange;
            CheckBox autoclose = new CheckBox("游戏结束后自动关闭（需要F5重启）", false);
            ...
            menu.Add("l1", new Label("By Christian Brutal Sniper - Fixed by EnfermeraSexy & TheYasuoMain 由CH汉化"));
